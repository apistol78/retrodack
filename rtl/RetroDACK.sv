...
module RetroDACK(
	...
	wire audio_dma_request;
	wire [31:0] audio_dma_address;
	...
	AUDIO_controller_4 audio_controller(
		...
		.i_rw(audio_rw),
		.i_address(audio_address[9:2]),
		.i_wdata(audio_wdata),
		.o_rdata(audio_rdata),
		.o_ready(audio_ready),

		.o_dma_request(audio_dma_request),
		.o_dma_address(audio_dma_address),
		.i_dma_ready(audio_dma_ready),
		.i_dma_rdata(audio_dma_rdata),
	...
	XBAR_4_12 xbar(
		...
		// Audio DMA
		.i_m2_rw(1'b0),
		.i_m2_request(audio_dma_request),
		.o_m2_ready(audio_dma_ready),
		.i_m2_address(audio_dma_address),
		.o_m2_rdata(audio_dma_rdata),
		.i_m2_wdata(32'h0),
		.i_m2_wmask(4'b1111),

		// DMA
		.i_m3_rw(dma_bus_rw),
		.i_m3_request(dma_bus_request),
		.o_m3_ready(dma_bus_ready),
		.i_m3_address(dma_bus_address),
		.o_m3_rdata(dma_bus_rdata),
		.i_m3_wdata(dma_bus_wdata),
		.i_m3_wmask(4'b1111),
